        ...
        >
                    ...
                    >
                        <div style={styles.logoContainer}>
                            <div>
                                ...
                                <p style={styles.green}>
                                    <b>Muhammed Can Inc.</b>
                                </p>
                            </div>
                        </div>
                        <div style={styles.headerInfo}>
                            <p>Released: 01/01/2024</p>
                            <p>MCCBIOS (C)2024 Ceylan Muhammed Can Inc.,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>HSP S13 2024 Special UC131S</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>MCC Showcase(tm) XX 113</p>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'Muhammed Can Ceylan Portfolio Showcase'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    <p>Muhammed Can Ceylan Portfolio Showcase</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
